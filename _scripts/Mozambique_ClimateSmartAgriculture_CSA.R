...
md<-read.csv("CSA_MOZ.csv",header=T)
phi<- md
...
cultivations<-  c("Maize","Rice","Wheat","Potato","Vegetable as group", "Soybean Meal Oilmeals", "Soybean Oils","Soybean as oils group",
...
cultivationsTrade<- c("Cattle-Meat", "Sheep & Goats","Poultry","Maize","Rice","Sorgum","Wheat", "Cassava",                   
                      ...
                      "Soybean Meal Oilmeals", "Cotton", "Soybean Oils" )
