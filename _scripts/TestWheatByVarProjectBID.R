...
########################## Procesamiento de datos trigo pasado y futuro---------
# file Future, load and processing -------------

setwd("C:/Users/CEGONZALEZ/Documents/BIDCarlos/BIDsecundVersion/Wheat_Future")
...
tiff(filename=paste(copy,"WheatVarietiesGCMs.tiff",sep=""), 
...
setwd("C:/Users/CEGONZALEZ/Documents/BIDCarlos/BIDsecundVersion/Wheat_Historical")
copy<- c("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/")
...
tiff(filename=paste(copy,"WheatVarietiesWFD.tiff",sep=""), 
     width = 18, height = 12, units = 'in', res = 100)
