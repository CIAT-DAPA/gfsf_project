...
# ########### PARTE B
# #cargar files
# crops<- c("soybean")  #, "soybean", "soybean", "soybean" "soybean", "Soysoybean"
...
#             
#             #hacer graficas
#             png(filename = paste(copyPix,"soybean","_","IRR_",pots[p],"_","trend",".png",sep=""), 
...
#             
#             #hacer graficas
#             png(filename = paste(copyPix,"soybean","_","RA_",pots[p],"_","trend",".png",sep=""), 
#                 width = 20, height = 12, units = 'in', res = 100)
#             require(ggplot2)
#             n<-ggplot(data=by_pots[[p]], aes(x=year,y=val,colour=pix))+ 
#                   geom_line(aes(group=pix))+
...
#             dev.off()
#       } else {
#             cat(paste(" SOY RA FPU: ", pots[[p]], " does not have varieties\n", sep = ""))
#       }
#       
# }
# 
